...
val commentsList = listOf<MockCommentModel>(
    ...
    MockCommentModel("https://i.ytimg.com/vi/ofHe_3tW3-s/hqdefault.jpg", "Фанта", "Пепси", "хороший инструктор, но 4 звезды, потому что я делал запись на 3 часа, но ездили мы час, а остальные 2 часа он сидел в чайхане с друзьями")
)